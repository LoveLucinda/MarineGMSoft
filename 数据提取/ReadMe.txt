================================================================================
    MICROSOFT 基础类库 : 数据提取 项目概述
===============================================================================

应用程序向导已为您创建了此 数据提取 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 数据提取 应用程序的每个文件的内容。

数据提取.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，其中包含生成该文件的 Visual C++ 的版本信息，以及有关使用应用程序向导选择的平台、配置和项目功能的信息。

数据提取.vcxproj.filters
    这是使用“应用程序向导”生成的 VC++ 项目筛选器文件。它包含有关项目文件与筛选器之间的关联信息。在 IDE 中，通过这种关联，在特定节点下以分组形式显示具有相似扩展名的文件。例如，“.cpp”文件与“源文件”筛选器关联。

数据提取.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 C数据提取App 应用程序类。

数据提取.cpp
    这是包含应用程序类 C数据提取App 的主应用程序源文件。

数据提取.rc
    这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源包含在 2052 中。

res\数据提取.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 数据提取.rc 中。
...
res\Toolbar.bmp
    此位图文件用于为工具栏创建平铺图像。
    初始工具栏和状态栏在 CMainFrame 类中构造。使用资源编辑器编辑此工具栏位图，并更新 数据提取.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
数据提取Doc.h、数据提取Doc.cpp - 文档
    这些文件包含 C数据提取Doc 类。编辑这些文件以添加特殊文档数据并实现文件保存和加载（通过 C数据提取Doc::Serialize）。
    该文档将包含以下字符串：
        文件扩展名：      DAT
        文件类型 ID：        My.Document
        主框架标题：  海洋重力数据预处理
        文档类型名称：       海洋重力数据
        筛选器名称：         海洋重力数据 Files (*.DAT)
        文件的新短名称：数据提取
        文件类型长名称：数据提取.Document

数据提取View.h、数据提取View.cpp - 文档视图
    这些文件包含 C数据提取View 类。
    C数据提取View 对象用于查看 C数据提取Doc 对象。

res\数据提取Doc.ico
    这是一个图标文件，用作 C数据提取Doc 类的 MDI 子窗口的图标。此图标包括在主资源文件 数据提取.rc 中。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 数据提取.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
